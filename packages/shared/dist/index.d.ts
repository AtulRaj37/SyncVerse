...
export interface ServerToClientEvents {
    ...
    S2C_WEBRTC_OFFER: (data: {
        senderId: string;
        offer: any;
    }) => void;
    S2C_WEBRTC_ANSWER: (data: {
        senderId: string;
        answer: any;
    }) => void;
    S2C_WEBRTC_ICE: (data: {
...
export interface ClientToServerEvents {
    ...
    C2S_WEBRTC_OFFER: (data: {
        targetUserId: string;
        offer: any;
    }) => void;
    C2S_UPDATE_QUEUE: (queue: {
        playlist: SharedPlaylist;
        trackIndex: number;
    } | null) => void;
    C2S_WEBRTC_ANSWER: (data: {
        targetUserId: string;
        answer: any;
    }) => void;
    C2S_WEBRTC_ICE: (data: {
